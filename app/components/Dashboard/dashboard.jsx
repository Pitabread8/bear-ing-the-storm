...
const Dashboard = () => {
  const firstRowCards = [
    ...
    { title: "Average Daily Temperature (ºC)", content: "Content" },
    { title: "Chances of Getting Swept Away", content: "Content" },
  ];
  ...
  const secondRowCards = [
    ...
    { title: "Health Risk: Low, Medium, High", content: "Content" },
  ];
